...
<body class="white-back">
    ...
    if (isset($_POST["loginbtn"])) {
        if (checkmobilevalidation($_POST["mobile"]) == 1) {
            if ($_POST["mobile"] != "") {
                $sql = "INSERT INTO register_clients(phone) VALUES (?)";
                            ...
                            <div class="form-group">
                                ...
                                <fieldset class="mobile-fieldset">
                                    ...
                                    <legend class="mobile-legend">شماره موبایل</legend>
                                        <input dir="rtl" type="text" class="form-control" id="mobile" name="mobile" maxlength="11" autocomplete="off">
